...
public class ConcertFragment extends Fragment {
    ...
    public static ConcertFragment newInstance(String action, String category, String sort) {
    ...
    @BindView(R.id.fragment_concert_rv)
...
//        Toast.makeText(getContext(), action + "  " + category + "  " + sort, Toast.LENGTH_SHORT).show();
        ShowListRequest request = new ShowListRequest(MyApplication.getContext(), action, "2", sort);
