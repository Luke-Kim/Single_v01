...
public class OperaFragment extends Fragment {
    ...
    public static OperaFragment newInstance(String action, String category, String sort) {
    ...
    @BindView(R.id.fragment_opera_rv)
...
//        Toast.makeText(getContext(), action + "  " + category + "  " + sort, Toast.LENGTH_SHORT).show();
        ShowListRequest request = new ShowListRequest(MyApplication.getContext(), action, "1", sort);
