...
//        inquiryAdapter = new InquiryAdapter();
//        inquiryAdapter.setOnAdapterItemClickListener(new InquiryAdapter.OnShowAdapterItemClickLIstener() {
//            @Override
...
//        RecyclerView recyclerView = (RecyclerView)view.findViewById(R.id.inquiry_etc_rv);
