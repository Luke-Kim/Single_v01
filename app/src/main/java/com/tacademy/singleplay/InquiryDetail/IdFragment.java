...
//        arrayGroup.add("공연시작 전에 공연 장소에 도착을 못할 것 같습니다.");
//        arrayGroup.add("현장결제말고 다른 결제 방법은 없나요?");
            arrayGroup.add("위시리스트 알람을 바꾸고 싶어요");
...
//        arrayChild.put(arrayGroup.get(1), arrayQ2);
            arrayChild.put(arrayGroup.get(0), arrayQ3);
        }
    }
}
